YUI.add('moodle-mod_aiquiz-quizbase', function (Y, NAME) {

/**
 * The AIQUIZBASE class to provide shared functionality to Modules within Moodle.
 *
 * @module moodle-mod_aiquiz-quizbase
 */
var AIQUIZBASENAME = 'mod_aiquiz-quizbase';

var AIQUIZBASE = function() {
    AIQUIZBASE.superclass.constructor.apply(this, arguments);
};
...
M.mod_aiquiz.quizbase = M.mod_aiquiz.quizbase || new AIQUIZBASE();

// Abstract functions that needs to be defined per format (course/format/somename/format.js)
M.mod_aiquiz.edit = M.mod_aiquiz.edit || {};
 ...
 */
M.mod_aiquiz.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
 ...
 * @return void
 */
M.mod_aiquiz.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
