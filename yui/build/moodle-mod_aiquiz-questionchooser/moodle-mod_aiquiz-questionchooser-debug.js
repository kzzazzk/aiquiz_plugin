YUI.add('moodle-mod_aiquiz-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_aiquiz-questionchooser'
});

M.mod_aiquiz = M.mod_aiquiz || {};
M.mod_aiquiz.init_questionchooser = function() {
    M.mod_aiquiz.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_aiquiz.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_aiquiz-util", "querystring-parse"]});
