...
class aiquiz_overview_report extends aiquiz_attempts_report {
    public function display($quiz, $cm, $course) {
        ...
        $hasquestions = aiquiz_has_questions($quiz->id);
    ...
    protected function get_new_question_for_regrade(stdClass $attempt,
        ...
        if ($this->structureforregrade === null) {
            ...
            $this->structureforregrade = $this->get_question_structure(
    ...
    private function get_question_structure(int $quizid, \context_module $quizcontext,
        ...
        foreach ($slotdata as $slot) {
            ...
            if ($slot->filtercondition) {
                ...
                $slot->questionid =  $slot->id; // Sometimes this is used as an array key, so needs to be unique.
