...
$string['modulename_help'] = 'The AI Quiz plugin allows the teacher to create personalized quizzes with questions automatically generated by AI from PDF documents uploaded to a course section.

The teacher defines the number of questions and the scoring for correct and incorrect answers. The generated questions are saved in the category associated with the quiz instance, identified according to the documents used and the section.

When a student takes an attempt, they receive personalized feedback generated by AI based on their answers and the provided content.

AI Quiz includes all the usual quiz functionalities, along with:

* Automatic question generation by AI
* Immediate AI-generated feedback tailored to the student\'s performance

AI Quizzes are ideal for:

* Course-adapted exams
* Automatic practice tests
